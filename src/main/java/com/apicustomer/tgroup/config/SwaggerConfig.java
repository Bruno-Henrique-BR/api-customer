package com.apicustomer.tgroup.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.apicustomer.tgroup.controller"))
                .paths(regex("/api.*"))
                .build()
                .apiInfo(metaInfo());
    }
    ...
    private ApiInfo metaInfo() {
        ...
        ApiInfo apiInfo = new ApiInfo(
                ...
                "1.0",
                "Terms of Service",
                new Contact("Bruno Henrique", "https://www.linkedin.com/in/bruno-henrique-santos-ara%C3%BAjo-735366165/",
                        "brunohenrique2208sb@gmail.com"),
